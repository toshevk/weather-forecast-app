...
try:
    ...
    place_error_message = """Unfortunately, we don't have weather information for the city you searched.
    Please check the spelling or try a different city nearby"""
    st.info(place_error_message)
